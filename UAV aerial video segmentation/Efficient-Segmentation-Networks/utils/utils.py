...
from utils.colorize_mask import cityscapes_colorize_mask, camvid_colorize_mask, ussd_colorize_mask
...
def save_predict(output, gt, img_name, dataset, save_path, output_grey=False, output_color=True, gt_color=False):
    ...
    if output_color:
        if dataset == 'cityscapes':
            ...
            output_color = ussd_colorize_mask(output)
    ...
    if gt_color:
        if dataset == 'cityscapes':
            ...
            gt_color = ussd_colorize_mask(gt)
