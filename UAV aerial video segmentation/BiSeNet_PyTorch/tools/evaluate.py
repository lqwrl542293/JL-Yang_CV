...
class SingleScaleEvalOA(object):
...
#                 print(f'[debug] im_sc shape {im_sc.shape}')
                im_sc = im_sc.cuda()
                logits = net(im_sc)[0]
...
#             print(f'[debug] keep shape {keep.shape}')
...
#                 minlength=n_classes ** 2
#             )
#             print(f'[debug] bincount shape {temp.shape}')
#             print(temp)
