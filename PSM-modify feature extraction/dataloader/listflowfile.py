...
def dataloader(filepath):
 ...
 #image = [img for img in classes if img.find('frames_cleanpass') > -1]#store all image folder in root dir
 #disp  = [dsp for dsp in classes if dsp.find('disparity') > -1]#store disparity folder in root dir
 ...
 driving_dir = '/data/users/mzy/sceneflowDataSet/decompressedFile/frames_cleanpass/'
 driving_disp = '/data/users/mzy/sceneflowDataSet/decompressedFile/disparity/'
