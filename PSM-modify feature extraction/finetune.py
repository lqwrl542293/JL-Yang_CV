...
def main():
    ...
    writer = SummaryWriter(log_dir='Baseline_finetune_from_scratch')
    for epoch in range(1, args.epochs + 1):
        ...
        writer.add_scalar('scalar/epoch_train_loss', total_train_loss / len(TrainImgLoader), epoch)
        ...
        writer.add_scalar('scalar/epoch_test_loss', total_test_loss / len(TestImgLoader) * 100, epoch)
